    ...
    <nav class="navbar navbar-expand-lg navbar-dark bg-dark">
      ...
      <div class="collapse navbar-collapse" id="navbarNavAltMarkup">
        <div class="navbar-nav">
          ...
          <a class="nav-item nav-link active" href="#">AHL <span class="sr-only">(current)</span></a>
    ...
    <div style="margin-bottom: 0;" class="jumbotron jumbotron-fluid">
      <div class="container">
        <div class="row">
          <div class="col-8">
            <div class="container">
              <h1 class="display-4">American Hockey League</h1>
              <p class="lead">Lets go Griffins</p>
            </div>
          </div>
          <div class="col-4">
    ...
    <table style="margin-bottom: 0;" class="table table-sm table-striped table-dark table-bordered table-hover">
      <thead>
        <tr>
          ...
          <th scope="col">NHL_Affiliate</th>
          <th scope="col">Actions</th>
          <th scope="col"><a href='addAHLclt.php'>Add New</a></th>
        </tr>
      </thead>
      <tbody>
        <?php
          ...
          while($row = $result->fetch_assoc()) {
            ...
            echo '  <td>' . $row['city'] . '</td>';
            echo '  <td>' . $row['name'] . '</td>';
            echo '  <td>' . $row['NHL_Affiliate'] . '</td>';
            echo "  <td><a href='edtAHLclt.php?city=" . $row['city'] . "'><i class='fas fa-edit'></i> EDIT</a>" . '</td>';
            echo "  <td><a href='delAHLsrv.php?city=" . $row['city'] .  "'><i class='fas fa-trash'></i>DEL</a>" . '</td>';
            echo '</tr>';
          }
        ?>
      </tbody>
