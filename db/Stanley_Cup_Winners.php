    ...
    <nav class="navbar navbar-expand-lg navbar-dark bg-dark">
      ...
      <div class="collapse navbar-collapse" id="navbarNavAltMarkup">
        <div class="navbar-nav">
          ...
          <a class="nav-item nav-link active" href="#">Stanley_Cup_Winners <span class="sr-only">(current)</span></a>
    ...
    <div style="margin-bottom: 0;" class="jumbotron jumbotron-fluid">
      <div class="container">
        <div class="row">
          <div class="col-8">
            <div class="container">
              <h1 class="display-4">Stanley Cup Winners</h1>
    ...
    <table style="margin-bottom: 0;" class="table table-sm table-striped table-dark table-bordered table-hover">
      <thead>
        <tr>
          ...
          <th scope="col">AvAge</th>
          <th scope="col">GP</th>
          <th scope="col">W</th>
          <th scope="col">L</th>
          <th scope="col">T</th>
          <th scope="col">PTS</th>
          <th scope="col"><a href='Stanley_Cup_Winners.php'>Add New</a></th>
        </tr>
      </thead>
      <tbody>
        <?php
          require_once 'dbconnect.php';
          $sql = "select * from Stanley_Cup_Winners";
          ...
          while($row = $result->fetch_assoc()) {
            ...
            echo '<td>' . $row['Lg'] . '</td>';
            echo '<td>' . $row['Team'] . '</td>';
            echo '<td>' . $row['AvAge'] . '</td>';
            echo '<td>' . $row['GP'] . '</td>';
            echo '<td>' . $row['W'] . '</td>';
            echo '<td>' . $row['L'] . '</td>';
            echo '<td>' . $row['T'] . '</td>';
            echo '<td>' . $row['PTS'] . '</td>';
            echo "<td><a href='edtStanley_Cup_Winnersclt.php?Season=" . $row['Season'] . "'>EDIT</a>" . ' ';
            echo "<a href='delStanley_Cup_Winnerssrv.php?Season=" . $row['Season'] .  "'>DEL</a>" . '</td>';
            echo '</tr>';
          }
        ?>
      </tbody>
