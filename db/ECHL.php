    ...
    <nav class="navbar navbar-expand-lg navbar-dark bg-dark">
      ...
      <div class="collapse navbar-collapse" id="navbarNavAltMarkup">
        <div class="navbar-nav">
          ...
          <a class="nav-item nav-link active" href="#">ECHL <span class="sr-only">(current)</span></a>
    ...
    <div style="margin-bottom: 0;" class="jumbotron jumbotron-fluid">
      <div class="container">
        <div class="row">
          <div class="col-8">
            <div class="container">
              <h1 class="display-4">East Coast League</h1>
              <p class="lead">Lets go Stingrays</p>
            </div>
          </div>
          <div class="col-4">
      ...
      <tbody>
        <?php
          ...
          while($row = $result->fetch_assoc()) {
            ...
            echo "  <td><a href='edtECHLclt.php?city=" . $row['city'] . "'><i class='fas fa-edit'></i> EDIT</a>" . '</td>';
            echo "  <td><a href='delECHLsrv.php?city=" . $row['city'] .  "'><i class='fas fa-trash'></i>DEL</a>" . '</td>';
            echo '</tr>';
          }
        ?>
      </tbody>
