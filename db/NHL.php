    ...
    <nav class="navbar navbar-expand-lg navbar-dark bg-dark">
      ...
      <div class="collapse navbar-collapse" id="navbarNavAltMarkup">
        <div class="navbar-nav">
          <a class="nav-item nav-link active" href="#">NHL <span class="sr-only">(current)</span></a>
    ...
    <div style="margin-bottom: 0;" class="jumbotron jumbotron-fluid">
      <div class="container">
        <div class="row">
          <div class="col-8">
            <div class="container">
              <h1 class="display-4">National Hockey League</h1>
    ...
    <table style="margin-bottom: 0;" class="table table-sm table-striped table-dark table-bordered table-hover">
      <thead>
        <tr>
          ...
          <th scope="col"><a href='addNHLclt.php'>Add New</a></th>
        </tr>
      </thead>
      <tbody>
        <?php
          ...
          while($row = $result->fetch_assoc()) {
            ...
            echo "  <td><a href='edtNHLclt.php?city=" . $row['city'] . "'><i class='fas fa-edit'></i> EDIT</a>" . '</td>';
            echo "  <td><a href='delNHLsrv.php?city=" . $row['city'] .  "'><i class='fas fa-trash'></i>DEL</a>" . '</td>';
            echo '</tr>';
          }
        ?>
      </tbody>
