    ...
    <nav class="navbar navbar-expand-lg navbar-dark bg-dark">
      ...
      <div class="collapse navbar-collapse" id="navbarNavAltMarkup">
        <div class="navbar-nav">
          ...
          <a class="nav-item nav-link active" href="#">Trophies <span class="sr-only">(current)</span></a>
    ...
    <div style="margin-bottom: 0;" class="jumbotron jumbotron-fluid">
      <div class="container">
        <div class="row">
          <div class="col-8">
            <div class="container">
              <h1 class="display-4">Trophies</h1>
    ...
    <table style="margin-bottom: 0;" class="table table-sm table-striped table-dark table-bordered table-hover">
      <thead>
        <tr>
          ...
          <th scope="col">Most_Recently_Won_By</th>
          <th scope="col">Most_All_Time_Wins</th>
          <th scope="col">Number_Of_Wins</th>


          <th scope="col"><a href='addTrophiesclt.php'>Add New</a></th>
        </tr>
      </thead>
      <tbody>
        <?php
          ...
          while($row = $result->fetch_assoc()) {
            ...
            echo '<td>' . $row['Most_Recently_Won_By'] . '</td>';
            echo '<td>' . $row['Most_All_Time_Wins'] . '</td>';
            echo '<td>' . $row['Number_Of_Wins'] . '</td>';
            echo "<td><a href='delTrophiessrv.php?Trophy=" . $row['Trophy'] .  "'>DEL</a>" . '</td>';
            echo '</tr>';
          }
        ?>
      </tbody>
